...
#import getMultiShapes
from PIL import Image
import time
from getMultiShapes import A
global img_path
...
#
    ...
    im.save("./test_img/mask/result_mask.png")


    imgPath = image_name
    maskPath = "./test_img/mask/result_mask.png"
    savePath = './test_img/mask/'


    getMultiShapes.getMultiShapes_yaml(imgPath, maskPath, savePath)  # without yaml 
...
def get_img_file(image_name):
    ...
    for parent, dirnames, filenames in os.walk(image_name):
        for image_name in filenames:
            if image_name.lower().endswith(('.png', '.jpg', '.jpeg','html')):
