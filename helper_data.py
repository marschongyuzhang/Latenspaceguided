...
def compute_average_faces(feature_idx, image_dim, data_loader, device=None, encoding_fn=None):
    ...
    avg_img_with_feat = torch.zeros(image_dim, dtype=torch.float32) # for the 31 smelling
    avg_img_without_feat = torch.zeros(image_dim, dtype=torch.float32) # dont smell
